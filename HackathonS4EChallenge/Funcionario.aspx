...
<div class="forms">
    ...
    <asp:TextBox ID="TXT_Salario" runat="server" maxlength="20" AutoPostBack="true" PlaceHolder="R$ " RequiredFieldValidator="true" onkeypress="return isNumber(event)" > </asp:TextBox>
